...
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://114026258621824", BackgroundTransparency = 0 },
...
local Tab1 = Window:MakeTab({"dandy world🧸", "dandy world🧸"})
...
local Tab1 = Window:MakeTab({"99 noites na floresta🌲", "99 noites na floresta🌲"})
...
Tab1:AddButton({"SkyBase Hub🏗", function(Value)
