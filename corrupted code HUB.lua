...
-- FunÃ§Ã£o de validaÃ§Ã£o de formato da key (exemplo com prefixo FREE_)
...
-- AÃ§Ã£o do botÃ£o Get Key
GetBtn.MouseButton1Click:Connect(function()
    setclipboard("https://lootdest.org/s?TUZVhsM5")
    notify("ðŸ”— Link Copiado", "Acesse o site para gerar sua key.", 3)
end)

-- AÃ§Ã£o do botÃ£o Verificar Key
VerifyBtn.MouseButton1Click:Connect(function()
    local inputKey = TextBox.Text:upper()

    if not isValidKeyFormat(inputKey) then
        message.Text = "âŒ Formato de key invÃ¡lido."
        notify("Erro", "Formato da key invÃ¡lido!", 4)
        return
    end

    if usedKeys[inputKey] then
        message.Text = "âŒ Essa key jÃ¡ foi usada! Use outra."
        notify("Erro", "âŒ Essa key Ã© repetida. Use outra!", 5)
        return
    end

    usedKeys[inputKey] = true
    message.Text = "âœ… Key correta! VocÃª entrou na whitelist."
    notify("Sucesso", "âœ… Key correta! Dando whitelist...", 5)

    -- Aqui vocÃª executa a funÃ§Ã£o liberada apÃ³s validaÃ§Ã£o
loadstring(game:HttpGet("https://raw.githubusercontent.com/davidgames3d/Script-roblox/main/w%20o19%2081%20oqna91.lua"))()
