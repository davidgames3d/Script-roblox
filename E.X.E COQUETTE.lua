...
local floatButton = new("TextButton", {
    ...
    BackgroundColor3 = Color3.new(0, 0, 0), BorderSizePixel = 0, AutoButtonColor = true, ZIndex = 10
})
new("UICorner", {Parent = floatButton, CornerRadius = UDim.new(1, 0)})
local floatLabel = new("TextLabel", {
    Parent = floatButton, Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 1,
    Text = "©", Font = Enum.Font.SourceSansBold, TextSize = 22, TextColor3 = Color3.new(1, 1, 1), ZIndex = 11
})
...
local title = new("TextLabel", {
    ...
    TextColor3 = Color3.new(1, 1, 1), Font = Enum.Font.SourceSansBold, TextSize = 28, ZIndex = 6
})
...
local avatarContainer = new("Frame", {
    ...
    Size = UDim2.new(0, 220, 0, 220), BackgroundColor3 = Color3.fromRGB(30, 30, 30), BorderSizePixel = 0, ZIndex = 6
})
...
local avatarImg = new("ImageLabel", {
    ...
    BackgroundTransparency = 1, ScaleType = Enum.ScaleType.Fit, ZIndex = 7
})

-- Info & buttons area
local infoArea = new("Frame", {
    Parent = panel, AnchorPoint = Vector2.new(0, 0.5), Position = UDim2.new(0.36, 0, 0.35, 0),
    Size = UDim2.new(0.58, 0, 0.7, 0), BackgroundTransparency = 1, ZIndex = 6
})
local creatorsLabel = new("TextLabel", {
    Parent = infoArea, Position = UDim2.new(0, 0, 0, 6), Size = UDim2.new(1, 0, 0, 28),
    BackgroundTransparency = 1, Text = CREATORS_TEXT, TextColor3 = Color3.new(1, 1, 1),
    Font = Enum.Font.SourceSans, TextSize = 18, TextXAlignment = Enum.TextXAlignment.Left, ZIndex = 7
})
local executorLabel = new("TextLabel", {
    Parent = infoArea, Position = UDim2.new(0, 0, 0, 36), Size = UDim2.new(1, 0, 0, 24),
    BackgroundTransparency = 1, Text = "Executor: " .. tostring(executorName), TextColor3 = Color3.new(1, 1, 1),
    Font = Enum.Font.SourceSans, TextSize = 16, TextXAlignment = Enum.TextXAlignment.Left, ZIndex = 7
})
local sponsorLabel = new("TextLabel", {
    Parent = infoArea, Position = UDim2.new(0, 0, 0, 60), Size = UDim2.new(1, 0, 0, 22),
    BackgroundTransparency = 1, Text = SPONSORS_TEXT, TextColor3 = Color3.new(1, 1, 1),
    Font = Enum.Font.SourceSans, TextSize = 16, TextXAlignment = Enum.TextXAlignment.Left, ZIndex = 7
})

-- Buttons container & factory
local buttonsContainer = new("Frame", {
    Parent = infoArea, Position = UDim2.new(0, 0, 0, 92), Size = UDim2.new(1, 0, 1, -92),
...
local function notify(text, time)
    pcall(function()
        local notice = new("TextLabel", {
            Parent = screenGui, Size = UDim2.new(0, 360, 0, 36), Position = UDim2.new(0.5, -180, 0.92, 0),
            BackgroundColor3 = Color3.new(0, 0, 0), TextColor3 = Color3.new(1, 1, 1),
            Text = text, Font = Enum.Font.SourceSansBold, TextSize = 16, ZIndex = 10
        })
...
-- Pandora
local PandoraScript = [[
-- Cole aqui o script Pandora/reanimate completo ou substitua por um loadstring com URL
-- Exemplo: loadstring(game:HttpGet("LINK_AQUI"))()
-- Aguardando script ou link para implementação
]]
...
local openSound = new("Sound", {Name = "OpenSound", Parent = screenGui, Volume = 0.7, Looped = false, ZIndex = 10})
local clickSound = new("Sound", {Name = "ClickSound", Parent = screenGui, Volume = 0.6, Looped = false, ZIndex = 10})
openSound.SoundId = "rbxassetid://183226440" -- Placeholder (system-like)
clickSound.SoundId = "rbxassetid://147722227" -- Placeholder (click)
...
-- Exemplo de como sobrescrever/registrar manualmente
